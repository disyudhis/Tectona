<div>
    <div class="dropdown">
        ...
        <!--end::Toggle-->
        <!--begin::Dropdown-->
        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up" wire:poll.10s>
            <!--begin::Header-->
            <div class="d-flex align-items-center py-5 px-8 rounded-top">
                <span class="btn btn-md btn-icon bg-white-o-15 mr-4">
                    <i class="flaticon-alert text-success"></i>
                </span>
                <div class="text-success m-0 flex-grow-1 mr-3">Notification
                    <span class="badge badge-danger">{{ $notifications ? $notifications->count() : '0' }}</span>
                </div>
                <div>
                    <button class="btn btn-sm btn-success" wire:click='markAsRead'>Mark As Read</button>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Scroll-->
