                ...
                <div class="wizard wizard-1">
                        ...
                        <div class="wizard-steps p-8 p-lg-10">
                            ...
                            <div class="wizard-step" data-wizard-type='step' data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">1. Buat Bahan Baku</h3>
                                </div>
                            ...
                            <div class="wizard-step" data-wizard-type='step' data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">2. Buat Kode Bahan Baku</h3>
                                </div>
                            </div>
                            {{-- End::Wizard step 2 --}}
                        </div>
                    ...
                    <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                        <div class="col-xl-12 col xxl-7">
                            <form class="form">
                                <div class="pb-5">
                                    <h4 class="mb-10 font-weight-bold text-dark">1. Buat Bahan Baku</h4>
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        <label>Nama Bahan Baku</label>
                                        <input type="text" wire:model='selected_bahan' class="form-control form-control-solid">
                                ...
                                <div class="pb-5">
                                    <h4 class="mb-10 font-weight-bold text-dark">2. Kode Bahan Baku</h4>
                                    <div class="form-group fv-plugins-icon-container has-success">
                                        <label>Kode Bahan Baku</label>
                                        <input type="text" wire:model='selected_jenis' class="form-control form-control-solid">
                ...
                <div class="modal-body d-flex justify-content-center align-items-center">
                    <div class="mx-auto text-center">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ $selected_bahan }}"
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{ $selected_jenis }}"
                                    class="form-control form-control-solid">
                            </div>
                        </div>
                        <div class="mt-5">
                            <button type="button" class="btn btn-outline-danger font-weight-bold" data-dismiss="modal"
                               >Close</button>
                            <button class="btn btn-outline-success" wire:click='createMaterial'>Tambahkan Produk</button>
                        </div>
                    </div>
                </div>
            </div>
