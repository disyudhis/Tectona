...
class RackController extends ApiController
{
    ...
    /**
     * @param RackService $service
     * @param Request $request
     */
    public function __construct(RackService $service, Request $request)
    {
     ...
     *
     * @param StoreRackRequest $request
     * @return JsonResponse
     */
     ...
     * @return JsonResponse
     */
    public function update(UpdateRackRequest $request, string $id)
    {
